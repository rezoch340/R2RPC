...
> 更新日期：2026-07-28。当前验证基线为后端 HTTP/WebSocket 黑盒 **209 passed**、
> Jest **11 suites / 40 tests**、前端 Playwright **13 passed**、OpenAPI
> **39 个路径模板 / 52 个操作 / 54 个 schema**；
> JavaScript SDK **11 tests**、Android SDK **8 tests**；
...
- `../deploy/1panel/UPDATE.md`：1Panel 生产备份、标签更新、验收、回滚与脱敏实机记录
