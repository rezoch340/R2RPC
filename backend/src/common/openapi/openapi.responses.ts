...
export const OPEN_API_SUCCESS_SCHEMAS: Record<string, SchemaDefinition> = {
  ...
  DeviceTokenController_list: schemaReference('DeviceTokenPage'),
  ...
  ProjectsController_info: schemaReference('ProjectInfoPage'),
  ProjectsController_stats: arraySchemaReference('ProjectStats'),
  ProjectsController_summary: schemaReference('ProjectSummary'),
  DashboardController_overview: schemaReference('DashboardOverview'),
  ...
  DevicesController_list: schemaReference('DevicePage'),
  ...
  AccessTokenController_list: schemaReference('AccessTokenPage'),
